...
<body>
		...
		<input name="name" placeholder="Enter Friend Name" class="name" required />
		<input name="frined" placeholder="Enetr Branch" class="email" type="text" required />
		<input name="distance" placeholder="distance" class="name" type="text" required />
		    <!-- <textarea rows="4" cols="50" name="subject" placeholder="Please enter your message" class="message" required></textarea> -->
		    <input name="submit" class="btn" type="submit" value="ADD FRIEND" />
		   <a href="friendlist.php"> <input name="" class="btn" type="submit" value="Back" />
		</form>
